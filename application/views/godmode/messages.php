                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <th><a class="sorting <?php if ($title == 'date_updated') : ?><?= $order; ?><?php endif;?>" data-title="date_updated" data-order="<?php if ($title == 'date_updated') : ?><?= $order; ?><?php else : ?>asc<?php endif;?>" href="<?= site_url('godmode/messages');?>">Date Updated</a></th>
